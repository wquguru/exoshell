# PRD Generator Mode (Multi-PRD Support)
...
2. **Ask for PRD slug name** (kebab-case, e.g., `prd-06-risk-management`)
3. Ask 3-5 clarifying questions (with lettered options)
4. Generate structured PRD
5. Save to `.claude/ralph-ryan/<prd-slug>/prd.md`

**Important:** Do NOT implement. Just create the PRD.

---

## Step 1: PRD Slug Name

First, ask user for the PRD directory name:

```
What should I name this PRD directory?

Suggested: prd-<number>-<feature-name> (e.g., prd-06-risk-management)

Enter slug name (kebab-case):
```
...
1. Create directory: `.claude/ralph-ryan/<prd-slug>/`
2. Save PRD to: `.claude/ralph-ryan/<prd-slug>/prd.md`
...
Before saving:
- [ ] Asked for PRD slug name
- [ ] Asked clarifying questions with lettered options
- [ ] Each story completable in one iteration
- [ ] Stories ordered by dependency
- [ ] Acceptance criteria are verifiable
- [ ] Created directory `.claude/ralph-ryan/<prd-slug>/`
- [ ] Saved to `.claude/ralph-ryan/<prd-slug>/prd.md`
